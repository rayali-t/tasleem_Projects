...
public class ManageEnterpriseJPanel extends javax.swing.JPanel {
    ...
    private void populateComboBox() {
        ...
        enterpriseTypeJComboBox.addItem("Select Option");
    ...
    private void initComponents() {
        ...
        enterpriseTypeJComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "select option" }));
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        if (!nameJTextField.getText().equals("")) {
            for (Enterprise e : network.getEnterpriseDirectory().getEnterpriseList()) {
                if (e.toString().equalsIgnoreCase(nameJTextField.getText())) {
                    JOptionPane.showMessageDialog(null, "Enterprise with same name already exists!");
            ...
            JOptionPane.showMessageDialog(null, "Enterprise name can't be blank.");
            enterpriseTypeJComboBox.setSelectedIndex(0);
        }
